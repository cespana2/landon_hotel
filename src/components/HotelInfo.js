...
const HotelInfo = () => {
  ...
  const loadServicesData = async () => {
    ...
    const resp = await fetch(
      "https://cg24iul2e4.execute-api.us-east-1.amazonaws.com/Production/services"
    );
  ...
  const loadAccessibilitiesData = async () => {
    // Query the API Gateway
    const resp = await fetch(
      "https://cg24iul2e4.execute-api.us-east-1.amazonaws.com/Production/accessibilities"
    );
    let jsonData = await resp.json();
